					...
					<table class="table table-hover table-bordered" id="sampleTable">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="teamGiveScore?teamId=<s:property value="#teamcompetion.team.teamId" />">
										<button class="add-back-style">评分</button>
									</a>
								</td>
							</tr>
        ...
        <div class="attend-list">
            ...
            <s:iterator value="#request.pageBean.list" id="teamcompetion">
            	<div class="condition-style">
						<s:if test="#teamcompetion.isPass == true">
						<div>
							<s:property value="#teamcompetion.team.teamId" />
            ...
            -->
            	<div class="condition-style">
					...
					<s:else>
						<a href="preGradeList">首页</a>
            										&nbsp;&nbsp;&nbsp;
            									<a
							href="preGradeList?page=<s:property value=" #request.pageBean.currentPage - 1"/>">上一页</a>
					</s:else>
					<s:if
						test="#request.pageBean.currentPage != #request.pageBean.totalPage &&
						#request.pageBean.totalPage != 0 ">
						<a
							href="preGradeList?page=<s:property value=" #request.pageBean.currentPage + 1"/>">下一页</a>
            										&nbsp;&nbsp;&nbsp;
            										<a
							href="preGradeList?page=<s:property value=" #request.pageBean.totalPage"/>">尾页</a>
					</s:if>
					<s:else>
            										下一页&nbsp;&nbsp;&nbsp;尾页
        										</s:else>
