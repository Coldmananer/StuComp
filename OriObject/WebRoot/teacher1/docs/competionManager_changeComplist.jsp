      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            ...
            <div class="tile-body"> 
        <form method="post" action="changeComplistdetails?compListId=<s:property value="#request.complist.compListId"/>">

          <div class="form-group">
                  <label class="control-label"><strong>团队名称</strong></label>
                  <div style="font-size:17px;color:#808069;width:300px;"><s:property value="#request.complist.teamName"/></div>
          </div>
          <div class="form-group">
                  <label class="control-label"><strong>团队成员</strong></label>
                  <div style="font-size:17px;color:#808069;width:300px;"><s:property value="#request.complist.teamMembersName"/></div>
          </div>
          <div class="form-group">
                  <label class="control-label"><strong>竞赛排名</strong></label>
                  <div style="font-size:17px;color:#808069;width:300px;"><s:property value="#request.complist.rank"/></div>
          </div>
          <div class="form-group">
                  <label class="control-label"><strong>竞赛分数</strong></label>
                  <div style="font-size:17px;color:#808069;width:300px;">
                  		<input type="text" name="score" value="<s:property value="#request.complist.score"/>" >
                  </div>
          </div>
          <div class="form-group">
                  <label class="control-label"><strong>团队备注</strong></label>
                  <div style="font-size:17px;color:#808069;width:300px;">
                  		<input type="text" name="tip" value="<s:property value="#request.complist.tips"/>" >
          ...
          <a href="changeComplistdetails?CompId=<s:property value="#request.CompId"/>"><button type="submit" style="border-style:none; width:60px; height:25px; color:#fff; background-color:#458B74;">保存</button></a>
          <a href="preGrade?CompId=<s:property value="#request.CompId"/>"><button type="button" style="border-style:none; width:60px; height:25px; color:#fff; background-color:#458B74;">返回</button></a>
          </div>
        </form>
