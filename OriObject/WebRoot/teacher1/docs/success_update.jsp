  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="createcomp.html"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">发布竞赛</span></a></li>
        ...
        <i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">竞赛管理</span></a></li>
    ...
    <main class="app-content">
      	竞赛信息修改成功 <br>
    	<a href="compshow?page=1">竞赛列表</a>
    	通过成功<br>
    	<a href="compmanage?page=0&compId=<%=request.getAttribute("compId") %>">返回竞赛管理</a>
    </main>
    ...
    <!-- Data table plugin-->
    <script type="text/javascript" src="<%=basePath%>/teacher1/docs/js/plugins/jquery.dataTables.min.js"></script>
