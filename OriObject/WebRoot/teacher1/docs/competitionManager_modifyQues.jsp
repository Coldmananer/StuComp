...
<html>
  ...
  <body class="app sidebar-mini rtl">
	...
	<form class="body" action="#" enctype="multipart/form-data"
		method="post">
		<div class="comp-quesansw">
			<input type="hidden" name="questionId" value="<s:property value="#request.question.questionId"/>" />
			<label for="comp-ques">题目</label><br> 
			<input type="text" id="comp-ques" name="ques" 
				value="<s:property value="#request.question.questionName"/>"/><br> 
			<label for="comp-ques_desc">题目描述</label><br>
			<script type="text/plain" class="uEditor" name="desc">
				${requestScope.question.questionIntro}</script>
			<label for="comp-answ">答案</label><br>
			<script type="text/plain" class="uEditor" name="answ">
				${requestScope.question.questionAnsw}</script>
		...
		<div class="but-style">
			...
			<a href="showQuestion?CompId=<s:property value="#session.competition.CompId"/>"><input type="button" value="取消"  class="tijiao-quxiao-style"/></a>
		</div>
