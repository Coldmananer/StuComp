...
<html>
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> 团队报名</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">报名中的竞赛</li>
          <li class="breadcrumb-item active"><a href="#">团队报名</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
							<s:iterator value="stlist" id="stuTeam">
								<tr>
									<th><s:property value="#stuTeam.Team.teamId" /></th>

									<td><s:property value="#stuTeam.Team.teamName" /></td>

		<td><a href="applyForComp.action?teamId=<s:property value="#stuTeam.Team.teamId"/>">报名</a></td>
								</tr>
							</s:iterator>
				</tbody>
						<tfoot>
