          ...
          <div class="tile">
            ...
            <div class="tile-body">            
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" value="${team.teamName}" disabled="true">
                </div>
                <div class="form-group">
                  <label class="control-label">团队介绍</label>
                  <textarea class="form-control"  disabled="true" rows="10">${team.teamIntro}</textarea>
                </div>          
                 ${message}   
            <div class="tile-footer">
            <form action="applyForTeam" method="post">
               <input type="hidden" name="teamId" value="${team.teamId }">
              <button class="btn btn-primary" onclick="return ref()" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>报名</button>
              </form>
            </div>
            </div>
          </div>
