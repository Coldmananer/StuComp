      ...
      <div class="row" style="width:500px;">
        <div class="col-md-12">
          <div class="tile">
            <div class="row">
              <div class="col-lg-6">
                <form id="person_info" action="ModifyPassword.action" method="post">
				
                 <div class="form-group">
                    <label for="exampleSelect1">密码保护问题</label>
                    <select class="form-control" id="exampleSelect1" name="passwordQue">
                      <option value="1">你母亲的姓名？</option>
                      <option value="2">你父亲的姓名？</option>
				...
				<div class="form-group">
                  ...
                  <input class="form-control" type="password" name="rePassword" id="repeatpassword">
                </div>
				<div class="tile-footer">
              <button class="btn btn-primary" type="button" onclick="validatepassword()">提交</button>
                </div>
                </form>
              </div>             
            </div>
    ...
    <script type="text/javascript">
     /* if(document.location.hostname == 'pratikborsadiya.in') {
	  ...
	  function validatepassword(){
		  var npasswordvalue=document.getElementById('newpassword').value;
		  var rpasswordvalue=document.getElementById('repeatpassword').value;
		  var form=document.getElementById('person_info');
		  if(npasswordvalue==rpasswordvalue){
			form.submit();
		  }else{
			  alert('两次输入密码不相等！');
		  }
