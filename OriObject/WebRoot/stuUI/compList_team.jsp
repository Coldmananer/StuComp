...
<html>
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> ${#session.comp.compName} 竞赛成绩榜</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">结束的竞赛</li>
          <li class="breadcrumb-item active"><a href="#">竞赛榜单</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
							<s:iterator value="cllist" id="cl">
								<tr>
									<th><s:property value="#cl.rank" /></th>

									<td><s:property value="#cl.teamName" /></td>

									<td><s:property value="#cl.teamMembersName" /></td>
									
									<td><s:property value="#cl.score" /></td>

                                    <td><s:property value="#cl.score" /></td>
									
									<td><s:property value="#cl.tips" /></td>
								</tr>
							</s:iterator>
				</tbody>
						<tfoot>
