...
<html>
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> 进行中的竞赛</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">我的竞赛</li>
          <li class="breadcrumb-item active"><a href="#">进行中的竞赛</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
                ...
                <tbody>
							<s:iterator value="tclist" id="teamComp">
								<tr>
									...
									<td><s:property value="#teamComp.competition.compstatus.compStateName" /></td>

                                    <td>
                                    <a href = "showCompDetialwithQue.action?compId=<s:property value="#teamComp.competition.compId"/>">详情</a>
                                    </td>
								</tr>
							</s:iterator>
				</tbody>
