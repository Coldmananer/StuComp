          ...
          <div class="tile">
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
							<s:iterator value="qlist" id="que">
								<tr>
									<th><s:property value="#que.questionNum" /></th>

									<td><s:property value="#que.questionName" /></td>
                                    
                                    <td><s:property value="#que.questionIntro" /></td>
                                    
                                    <td>
                                    <a href = "downLaodQue.action?downPath=<s:property value="#que.fileDesc"/>">下载描述文件</a>
                                    <a href="showQueIntro?queId=<s:property value="#que.questionId"/>">查看题目描述</a>
                                    </td>
								</tr>
							</s:iterator>
				</tbody>
