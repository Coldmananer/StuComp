      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            ...
            <s:if test="#session.comp.compstatus.compStateId==3">
         <button class="btn btn-primary" type="button" onclick="javascript:window.location.href='showQue.action?compId=<s:property value="comp.compId"/>'">查看竞赛题目</button>
           </s:if>
           <s:else>
                                            请等待竞赛题目发布
           </s:else>
