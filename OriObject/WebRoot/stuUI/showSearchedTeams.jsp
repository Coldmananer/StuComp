							...
							<s:iterator value="#request.pageBean.list" id="stuTeam">
								<tr>
									...
									<td><s:property value="#stuTeam.Student.stuNum" /></td>
									  ...
									  <td><a href="showTeamDetial?teamId
            									=<s:property value=" #stuTeam.Team.teamId"/>">详情</a>
									</td >
									...
									<div >
										...
										<s:else>
											<a href="search?page=1">首页</a>
            										&nbsp;&nbsp;&nbsp;
            									<a href="search?page=<s:property value="#request.pageBean.currentPage - 1"/>">上一页</a>
										</s:else>
										<s:if
											test="#request.pageBean.currentPage != #request.pageBean.totalPage">
											<a href="search?page=<s:property value="#request.pageBean.currentPage + 1"/>">下一页</a>
            										&nbsp;&nbsp;&nbsp;
            										<a href="search?page=<s:property value="#request.pageBean.totalPage"/>">尾页</a>
										</s:if>
										<s:else>
            										下一页&nbsp;&nbsp;&nbsp;尾页
        										</s:else>
